...
mod tests {
    ...
    fn drives_dependency_chain_in_order_no_model() {
        ...
        let out = drive(
            &sim,
            &DriveOpts { max_iters: 10, max_retries: 0, store_path: store, workspace_root: None, escalation: None },
    ...
    fn recovers_failing_node_without_nudge_no_model() {
        ...
        let out = drive(
            &sim,
            &DriveOpts { max_iters: 5, max_retries: 2, store_path: store, workspace_root: None, escalation: None },
            |_, _| {},
        )
        .unwrap();
